...
def _profile_user_agent() -> str:
    """Return a ``poormad-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from poormad_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"poormad-cli/{_ver}"
    except Exception:
        return "poormad-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # poormad-cli UA so the catalog endpoint is reachable.
