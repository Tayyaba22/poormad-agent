...
The unit tests in tests/poormad_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned poormad-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/poormad")
from poormad_cli.service_manager import S6ServiceManager
