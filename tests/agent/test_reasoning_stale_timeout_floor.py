...
thinking phase.  PoorMad's default cloud-stream stale detector
(``POORMAD_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``POORMAD_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
