...
class TestHeaderNormalization:
    ...
    def test_mixed_case_headers_parsed(self):
        headers = {
            "X-PoorMad-Credits-Version": "1",
            "X-PoorMad-Credits-Remaining-Micros": micros(5.00),
            "X-PoorMad-Credits-Remaining-Usd": "5.00",
            "X-PoorMad-Credits-Subscription-Micros": micros(5.00),
            "X-PoorMad-Credits-Subscription-Usd": "5.00",
            "X-PoorMad-Credits-Rollover-Micros": "0",
            "X-PoorMad-Credits-Purchased-Micros": "0",
            "X-PoorMad-Credits-Purchased-Usd": "0.00",
            "X-PoorMad-Tool-Pool-Micros": "0",
            "X-PoorMad-Tool-Pool-Gated-Off": "false",
            "X-PoorMad-Credits-Denominator-Kind": "none",
            "X-PoorMad-Credits-Paid-Access": "true",
            "X-PoorMad-Credits-As-Of-Ms": "1717000000000",
        }
        state = parse_credits_headers(headers)
        assert state is not None
