...
CA bundle env vars (POORMAD_CA_BUNDLE, REQUESTS_CA_BUNDLE, SSL_CERT_FILE)
...
_CA_ENV_VARS = ("POORMAD_CA_BUNDLE", "REQUESTS_CA_BUNDLE", "SSL_CERT_FILE")
...
class TestResolveRequestsVerify:
    ...
    def test_priority_poormad_over_requests(self, clean_env, tmp_path, bundle_file):
