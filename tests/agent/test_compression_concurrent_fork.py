...
Damien's incident (Discord, 2026-05-28): a long PoorMad session in a Discord
...
def _make_legacy_session_db_class() -> type:
    ...
    imports the same still-loaded ``poormad_state`` module, whose ``SessionDB``
    ...
    namespace = {"__name__": "poormad_state"}
    source = '''
class SessionDB:
...
_NominalSessionDBImpostor.__module__ = "poormad_state"
