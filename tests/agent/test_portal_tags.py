"""Tests for agent.portal_tags — PoorMad Portal request tag contract."""
...
def test_nous_portal_tags_contains_product_and_client():
    """Every PoorMad Portal request gets BOTH the product tag and the version tag."""
    from agent.portal_tags import poormad_client_tag, nous_portal_tags
