...
from poormad_cli.nous_account import PoorMadPortalAccountInfo, PoorMadPaidServiceAccessInfo


def _account(**kwargs) -> PoorMadPortalAccountInfo:
...
def test_credits_command_fully_removed():
    ...
    from poormad_cli.commands import resolve_command, COMMAND_REGISTRY
