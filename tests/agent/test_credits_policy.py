...
class TestIsFreeTierModel:
    ...
    def test_pricing_cache_peek_zero_priced_model(self, monkeypatch):
        ...
        assert is_free_tier_model("some/zero-priced", "https://api.poormad.dev/") is True
        assert is_free_tier_model("some/zero-priced", "https://api.poormad.dev/v1/") is True
    ...
    def test_exception_fails_open_to_false(self, monkeypatch):
        ...
        assert is_free_tier_model("some/model", "https://api.poormad.dev") is False
    ...
    def test_stealth_prefix_detected_as_free(self):
        ...
        assert is_free_tier_model("stealth/ox-alpha", "https://api.poormad.dev/v1") is True
