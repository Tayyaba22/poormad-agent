...
class TestDefaultContextLengths:
    ...
    def test_deepseek_v4_models_1m_context(self):
        ...
        # / PoorMad Portal) to 1M without probing down to the legacy 128K
...
# =========================================================================
# PoorMad Portal context-window resolution (provider="nous")
# =========================================================================

class TestPoorMadPortalContextResolution:
    """PoorMad Portal /v1/models is authoritative for what PoorMad infra enforces
    ...
    def test_empty_model_never_fuzzy_matches_endpoint_catalog(self, mock_fetch):
        ...
        the PoorMad portal) and poisoned the resolved context length."""
        import agent.model_metadata as mm
        ...
        assert mm._resolve_endpoint_context_length(
            "grok-4.6", "https://api.poormad.dev/v1"
        ) == 500_000
