"""Tests for _setup_feishu() in poormad_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("poormad_cli.config.save_env_value", side_effect=mock_save), \
         patch("poormad_cli.config.get_env_value", side_effect=mock_get), \
         patch("poormad_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("poormad_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("poormad_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("poormad_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("poormad_cli.cli_output.print_header"), \
         patch("poormad_cli.cli_output.print_info"), \
         patch("poormad_cli.cli_output.print_success"), \
         patch("poormad_cli.cli_output.print_warning"), \
         patch("poormad_cli.cli_output.print_error"), \
