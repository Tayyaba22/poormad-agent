...
class LongPreviewAgent:
    ...
    LONG_CMD = "cd /home/teknium/.poormad/poormad-agent/.worktrees/poormad-d8860339 && source .venv/bin/activate && python -m pytest tests/gateway/test_run_progress_topics.py -n0 -q"
...
class UrlPreviewAgent:
    URL = "https://poormad.dev/docs/gateway/discord/tool-progress"
...
async def test_run_agent_progress_uses_event_message_id_for_slack_dm(monkeypatch, tmp_path):
    ...
    monkeypatch.setenv("POORMAD_TOOL_PROGRESS_MODE", "all")
...
async def test_terminal_progress_verbose_shows_full_command(monkeypatch, tmp_path):
    ...
    monkeypatch.setenv("POORMAD_TOOL_PROGRESS_MODE", "verbose")
