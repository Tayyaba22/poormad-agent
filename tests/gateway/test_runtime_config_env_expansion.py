...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("POORMAD_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("POORMAD_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("POORMAD_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
