...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.poormad/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at poormad_state import time, before pytest's POORMAD_HOME monkeypatch
    fires — the autouse fixture's POORMAD_HOME override doesn't help here.)
    """
