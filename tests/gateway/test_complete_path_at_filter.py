...
def _reset_fuzzy_cache(monkeypatch):
    ...
    # via _load_cfg(), which resolves through _poormad_home captured at module
    # import time — before the per-test POORMAD_HOME redirect applies. When the
