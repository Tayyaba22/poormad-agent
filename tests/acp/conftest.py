...
Keeps the ACP server tests offline: ``PoorMadACPAgent._build_model_state``
calls ``poormad_cli.inventory.build_models_payload``, which (without this
...
def _offline_model_inventory(monkeypatch):
    ...
    import poormad_cli.inventory as inventory
