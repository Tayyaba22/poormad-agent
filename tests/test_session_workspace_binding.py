"""Session <-> workspace grouping key (poormad_state.workspace_key).

The key is what `poormad sessions list --workspace` groups/filters on. It is a
...
from poormad_state import workspace_key
