...
def make_poormad_home(base: Path, journal_mode: str) -> Path:
    """Create an isolated POORMAD_HOME whose config pins ``database.journal_mode``.
    ...
    """
    home = base / f"poormad-home-{journal_mode}"
