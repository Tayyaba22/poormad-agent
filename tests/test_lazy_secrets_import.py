"""Regression test: poormad update must not load cryptography eagerly."""
...
assert 'poormad_cli.secrets_cli' not in sys.modules, \\
...
"""
    ...
    def test_update_check_no_cryptography(self) -> None:
        """Running poormad update --check should NOT load cryptography._rust."""
        # Write a small script in the repo root so poormad_cli is importable,
...
import poormad_cli.main
from poormad_cli.update_cmd import _cmd_update_check
