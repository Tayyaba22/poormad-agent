...
* ``poormad_constants.get_poormad_dir`` (cache path)
...
def tmp_cache_dir(tmp_path):
    """Override get_poormad_dir so cache writes land under tmp_path."""
    ...
    with patch("poormad_constants.get_poormad_dir", _fake_get):
        yield cache_dir
