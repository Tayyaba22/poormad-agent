...
FIXTURE_NO_PROVIDER = (
    "agent init failed: No LLM provider configured. Run `poormad model` to select "
    "a provider, or run `poormad setup` for first-time configuration."
)
FIXTURE_NO_TOKEN = "agent init failed: No access token found for PoorMad Portal login."
