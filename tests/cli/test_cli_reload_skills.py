"""Tests for the ``/reload-skills`` CLI slash command (``PoorMadCLI._reload_skills``).
...
def _make_cli():
    """Build a minimal PoorMadCLI shell exposing ``_reload_skills``."""
    import cli as cli_mod

    obj = object.__new__(cli_mod.PoorMadCLI)
