...
from poormad_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/poormad_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("poormad_cli.lifecycle.invoke_hook")
@patch("poormad_cli.lifecycle.finalize_session")
