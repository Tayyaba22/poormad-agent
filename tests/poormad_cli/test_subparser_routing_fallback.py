...
The main() function in poormad_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `poormad -c model`
...
def _build_parser():
    """Build a minimal replica of the poormad top-level parser."""
