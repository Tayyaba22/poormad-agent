...
def client(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("POORMAD_DASHBOARD_SESSION_TOKEN", "soul-test-token")
...
def profile_dir(tmp_path, monkeypatch) -> Path:
    """Create a real profile directory under the test POORMAD_HOME."""
    monkeypatch.setenv("POORMAD_HOME", str(tmp_path))
...
class TestSoulWriteDurability:
    ...
    def test_existing_soul_survives_an_interrupted_save(
        ...
        # POORMAD_HOME patch the client/profile_dir fixtures installed.
