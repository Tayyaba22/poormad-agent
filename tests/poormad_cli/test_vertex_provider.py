...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (poormad_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_poormad_overlays():
    """poormad_cli.providers.get_provider("vertex") backs
