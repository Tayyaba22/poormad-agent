"""Tests for the ``poormad prompt-size`` diagnostic (issue #34667)."""
...
from poormad_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(poormad_home, memory_text="", user_text=""):
    mem_dir = poormad_home / "memories"
...
def _seed_skill(poormad_home, name, description):
    skill_dir = poormad_home / "skills" / "demo" / name
