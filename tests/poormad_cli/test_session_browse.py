"""Tests for the interactive session browser (`poormad sessions browse`).
...
from poormad_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """poormad sessions browse should be parseable."""
