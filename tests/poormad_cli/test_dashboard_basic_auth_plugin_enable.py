...
from poormad_cli.dashboard_auth import clear_providers, list_providers
from poormad_cli.plugins import PluginManager, discover_plugins
...
class TestBasicProviderLoadsAfterUnblock:
    def test_disabled_basic_blocks_registration(self, poormad_home, monkeypatch):
    ...
    def test_unblock_then_rediscover_registers_provider(
        ...
        _write_config(poormad_home, cfg)
