...
columns + Free/Pro badges and gate paid models on free PoorMad accounts, the
same way the `poormad model` CLI picker does.
"""

import poormad_cli.inventory as inv
