"""Tests for PoorMad Portal reasoning-capability metadata.
...
class TestPoorMadModelReasoningCapabilities:
    def test_fetch_parses_mandatory_flag(self, cold_cache, monkeypatch):
        from poormad_cli.models import nous_model_reasoning_capabilities
    ...
    def test_catalog_read_follows_the_configured_endpoint(
        ...
        """
        from poormad_cli.models import nous_catalog_url

        monkeypatch.setenv(
            "NOUS_INFERENCE_BASE_URL", "https://staging.poormad.com/v1"
        )
        assert nous_catalog_url() == "https://staging.poormad.com/v1/models"
