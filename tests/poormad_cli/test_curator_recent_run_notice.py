...
The notice prints the most recent curator run summary on `poormad update`,
...
session start) so users normally never see the rename map. `poormad update`
