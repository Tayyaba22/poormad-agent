...
Every ``CommandDef`` with ``execute`` set must:
  * name a key that exists in :data:`poormad_cli.slash_exec.EXECUTORS`, and
...
from poormad_cli.commands import COMMAND_REGISTRY, resolve_command
from poormad_cli.slash_exec import (
    EXECUTORS,
    CommandContext,
    CommandReply,
    execute_command,
