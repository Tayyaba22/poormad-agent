"""Tests for ``poormad approvals suggest`` (poormad_cli/approvals_suggest.py).

Approval history in PoorMad is implied, not ledgered: the session DB
...
from poormad_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,
