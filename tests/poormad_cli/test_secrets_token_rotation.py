"""Tests for `poormad secrets bitwarden token` / `poormad secrets onepassword token`.
...
from poormad_cli import onepassword_secrets_cli as op_cli
from poormad_cli import secrets_cli as bw_cli
