"""Tests for `poormad curator status` output.
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated POORMAD_HOME with real agent-created skills on disk."""
    ...
    from poormad_cli import curator as curator_cli
...
def test_adopt_subcommand_is_registered():
    ...
    import poormad_cli.curator as curator_cli
