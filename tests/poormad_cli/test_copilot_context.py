...
class TestGetCopilotModelContext:
    ...
    @patch("poormad_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("poormad_cli.models._urlopen_model_catalog_request")
    ...
    @patch("poormad_cli.models.fetch_github_model_catalog", return_value=[])
