"""Tests for the specifier module + `poormad kanban specify` CLI surface.
...
from poormad_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `poormad kanban …` argparse surface directly."""
