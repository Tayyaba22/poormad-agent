"""Tests for the shared byte formatter (poormad_cli.sizefmt).
...
def test_migrated_sites_render_through_the_shared_helper():
    ...
    from poormad_cli.backup import _format_size as backup
    from poormad_cli.checkpoints import _fmt_bytes as checkpoints
    from poormad_cli.doctor import _human_bytes as doctor
