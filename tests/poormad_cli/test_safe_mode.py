"""Tests for `poormad chat --safe-mode` isolation."""
...
_VARS = ("POORMAD_SAFE_MODE", "POORMAD_IGNORE_USER_CONFIG", "POORMAD_IGNORE_RULES")
...
def test_cmd_chat_safe_mode_sets_env_before_startup(monkeypatch):
    ...
    def fake_has_provider() -> bool:
        assert os.environ["POORMAD_SAFE_MODE"] == "1"
        assert os.environ["POORMAD_IGNORE_USER_CONFIG"] == "1"
        assert os.environ["POORMAD_IGNORE_RULES"] == "1"
        return True
