...
The oneshot path builds its AIAgent directly (bypassing PoorMadCLI), so the
...
from poormad_cli.oneshot import _build_preloaded_skills_prompt, _normalize_skills
