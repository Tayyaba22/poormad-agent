"""Tests for `_can_open_graphical_browser()` in poormad_cli.auth.

Guards the fix for the May 2026 report where `poormad auth add xai-oauth`
...
from poormad_cli.auth import _can_open_graphical_browser
