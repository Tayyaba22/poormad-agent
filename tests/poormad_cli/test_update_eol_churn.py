"""Regression: ``poormad update`` should take a managed checkout off autocrlf=true.
...
``poormad update`` has to repair them.
...
from poormad_cli.update_cmd import _normalize_managed_eol
