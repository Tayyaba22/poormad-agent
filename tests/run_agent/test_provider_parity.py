...
class TestBuildApiKwargsPoorMadPortal:
...
# ── Chat completions response handling (OpenRouter/PoorMad) ─────────────────────
...
class TestAuxiliaryClientProviderPriority:
    ...
    def test_custom_endpoint_when_no_nous(self, monkeypatch):
        """Custom endpoint is used when no OpenRouter/PoorMad keys are available.
