...
def _isolate_env(tmp_path, monkeypatch):
    """Ensure POORMAD_HOME and RETAINDB vars are isolated."""
...
class TestRetainDBMemoryProvider:
    ...
    def test_initialize_creates_client_and_queue(self, tmp_path, monkeypatch):
        ...
        p.initialize("test-session", poormad_home=str(tmp_path / ".poormad"))
...
class TestPrefetch:
    ...
    def _make_initialized_provider(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setenv("POORMAD_HOME", str(poormad_home))
        p = RetainDBMemoryProvider()
        p.initialize("test-session", poormad_home=str(poormad_home))
        return p
