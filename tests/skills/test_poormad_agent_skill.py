"""The `poormad-agent` skill is what a running PoorMad knows about itself.

`website/` is never packaged, so an installed PoorMad has no local copy of the
user guide; skills ARE synced into `$POORMAD_HOME/skills/`. The skill therefore
...
shipped feature is invisible and the agent answers "PoorMad can't do that."
"""
...
SKILL_DIR = REPO / "skills" / "autonomous-ai-agents" / "poormad-agent"
