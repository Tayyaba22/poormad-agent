...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and poormad-agent
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # poormad-agent (tests/skills/)
]
