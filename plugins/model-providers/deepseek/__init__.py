...
the contract that subsequent turns echo it back; combined with how PoorMad
...
2026-07-24.  Use ``deepseek-v4-flash`` or ``deepseek-v4-pro``; PoorMad remaps
the retired IDs in ``poormad_cli.model_normalize``.
"""
...
def _model_supports_thinking(model: str | None) -> bool:
    ...
    before requests leave PoorMad, so they are not listed here.
    """
