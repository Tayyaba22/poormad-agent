...
request omits ``thinking``.  PoorMad' ``reasoning_config = {"enabled": False}``
...
:meth:`ZaiProfile.build_api_kwargs_extras` translates the PoorMad reasoning
...
(per Z.AI / BigModel docs).  PoorMad' richer effort scale is collapsed onto
...
def _glm_5_2_reasoning_effort(
    ...
    """Map PoorMad reasoning effort onto GLM's native vocabulary.
