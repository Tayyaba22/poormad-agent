...
# When the user hasn't picked a reasoning effort, PoorMad passes
...
# ON at this effort — matching the "medium (default)" that PoorMad' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map PoorMad' effort vocabulary onto Solar's accepted set via the
