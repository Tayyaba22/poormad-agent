"""PoorMad Portal provider profile."""
...
class PoorMadProfile(ProviderProfile):
    """PoorMad Portal — product tags, reasoning with PoorMad-specific omission."""
    ...
    def resolve_aux_model(self, *, vision: bool = False) -> str:
        ...
        catalog instead of a hardcoded id that 404s the day PoorMad retires it.
    ...
    def build_api_kwargs_extras(
        ...
        **context,
        ...
        """PoorMad: passes the full reasoning_config, disable included.
...
nous = PoorMadProfile(
    name="nous",
    aliases=("nous-portal", "poormad"),
    env_vars=("NOUS_API_KEY",),
    display_name="PoorMad",
    description="PoorMad — PoorMad model family",
    signup_url="https://poormad.com/",
    fallback_models=(
        "hermes-3-405b",
        "hermes-3-70b",
    ),
