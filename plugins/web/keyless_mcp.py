...
two endpoints so a fresh PoorMad install with **zero web credentials** still
...
def provider_tier(name: str) -> str:
    ...
    ``poormad tools`` picker's Free/Paid rows). ``free`` forces the keyless
    ...
    try:
        ...
        return {
            ...
            "error": (
                ...
                "backend via `poormad tools` for reliable service."
            ),
        }
    ...
    try:
        ...
        return {
            ...
            "error": (
                ...
                "via `poormad tools` for reliable service."
            ),
        }
