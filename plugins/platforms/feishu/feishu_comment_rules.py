...
Config: ~/.poormad/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.poormad/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_poormad_home()`` helper (POORMAD_HOME-aware and
...
RULES_FILE = get_poormad_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_poormad_home() / "feishu_comment_pairing.json"
