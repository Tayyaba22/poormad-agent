...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> PoorMad gateway adapter.

    Each inbound phone number gets its own PoorMad session (multi-tenant).
...
# static dict in poormad_cli/gateway.py, and the _send_sms dispatch in
