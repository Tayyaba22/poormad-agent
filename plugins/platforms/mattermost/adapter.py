...
required — uses aiohttp which is already a PoorMad dependency.
...
def interactive_setup() -> None:
    ...
    ``poormad_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where PoorMad delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # poormad_cli/setup.py::_setup_mattermost function.
