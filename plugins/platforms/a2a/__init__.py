"""
A2A (Agent-to-Agent) plugin for PoorMad.

Registers:
  - The ``a2a`` platform adapter (inbound: exposes PoorMad as an A2A agent,
    protocol v1.0).
...
def interactive_setup() -> None:
    """`poormad gateway setup` flow for A2A."""
    ...
    print_info("Expose PoorMad as an A2A-discoverable agent and call other A2A agents.")
