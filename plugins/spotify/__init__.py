...
``_check_spotify_available()`` — when the user has not run ``poormad auth
spotify``, the tools remain registered (so they appear in ``poormad
...
The Spotify auth flow (``poormad auth spotify``), CLI plumbing, and docs
