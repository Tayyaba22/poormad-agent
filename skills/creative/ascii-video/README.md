...
Built for [PoorMad](https://github.com/Tayyaba22/poormad-agent). Usable in any coding agent. Canonical source lives here; synced to [`PoorMad/poormad-agent/skills/creative/ascii-video`](https://github.com/Tayyaba22/poormad-agent/tree/main/skills/creative/ascii-video) via PR.
