/**
 * PoorMad desktop plugin template. Save as:
 *   <poormad home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <poormad home> is ~/.poormad by default, or ~/.poormad/profiles/<name>
 * when running a named profile (`poormad -p <name>`). Run `poormad doctor` (or
 ...
 * Only these imports resolve: @poormad/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@poormad/plugin-sdk'
