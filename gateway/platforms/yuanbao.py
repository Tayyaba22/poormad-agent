...
_APP_VERSION = _POORMAD_VERSION
_BOT_VERSION = _POORMAD_VERSION
_YUANBAO_INSTANCE_ID = str(POORMAD_INSTANCE_ID)  # single source: yuanbao_proto.POORMAD_INSTANCE_ID
        ...
        if not adapter._auto_sethome_done and adapter._sender_may_designate_home(ctx):
            ...
            if _should_set:
                try:
                    ...
                    from poormad_cli.config import atomic_config_write, read_user_config_raw
