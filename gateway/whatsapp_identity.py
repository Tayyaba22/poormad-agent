...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$POORMAD_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_poormad_dir("platforms/whatsapp/session", "whatsapp/session")
