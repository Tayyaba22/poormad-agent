...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your PoorMad session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show PoorMad session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running PoorMad"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update PoorMad to the latest version"},
        {"name": "restart", "description": "Gracefully restart the PoorMad gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a PoorMad session in it",
