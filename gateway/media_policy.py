...
from environment variables:
  ...
  - ``POORMAD_MEDIA_DELIVERY_STRICT``    <- gateway.strict
  - ``POORMAD_MEDIA_ALLOW_DIRS``         <- gateway.media_delivery_allow_dirs
  - ``POORMAD_MEDIA_TRUST_RECENT_FILES`` <- gateway.trust_recent_files
...
gateway — a manual ``poormad cron run`` in the CLI, ``poormad send``, a
...
_STRICT_ENV = "POORMAD_MEDIA_DELIVERY_STRICT"
_ALLOW_DIRS_ENV = "POORMAD_MEDIA_ALLOW_DIRS"
_TRUST_RECENT_ENV = "POORMAD_MEDIA_TRUST_RECENT_FILES"
