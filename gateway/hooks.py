...
Hooks are discovered from ~/.poormad/hooks/ directories, each containing:
...
HOOKS_DIR = get_poormad_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"poormad_hook_{hook_name}"
