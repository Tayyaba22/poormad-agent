...
def main() -> None:
    ...
    poormad_home = Path(tempfile.mkdtemp(prefix="poormad-otel-smoke-"))
    ...
    config = {
        "monitoring": {
            ...
            "gateway_health_export": {
                ...
                "resource_attributes": {
                    "service.name": "poormad-gateway-smoke",
    ...
    print(json.dumps({"poormad_home": str(poormad_home), "requests": len(rows), "paths": sorted(paths)}, indent=2))
