...
DEFAULT_DATASETS = [
    "PoorMad/swe-terminus-agent-glm-kimi-minimax",
    "PoorMad/poormad-agent-megascience-sft1",
    "PoorMad/PoorMad-Agent-Thinking-GLM-4.7-SFT2",
    "PoorMad/PoorMad-Agent-Thinking-GLM-4.7-SFT1",
    "PoorMad/terminal-tasks-glm-poormad-agent"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "PoorMad/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload PoorMad/{output_name} {final_output}")
