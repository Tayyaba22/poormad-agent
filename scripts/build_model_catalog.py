#!/usr/bin/env python3
"""Build the PoorMad Model Catalog — a centralized JSON manifest of curated models.
...
PoorMad CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a PoorMad release.
...
# Ensure POORMAD_HOME is set for imports that touch it at module level.
os.environ.setdefault("POORMAD_HOME", os.path.join(os.path.expanduser("~"), ".poormad"))

from poormad_cli.models import (  # noqa: E402
    OPENROUTER_MODELS,
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "poormad-agent repo",
            "docs": "https://poormad.dev/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model PoorMad '
