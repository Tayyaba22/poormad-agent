#!/usr/bin/env python3
"""Summarize micro-compaction telemetry from PoorMad logs.
...
With no LOGFILE, reads ``$POORMAD_HOME/logs/agent.log`` (default ~/.poormad).
...
def default_log() -> Path:
    home = os.environ.get("POORMAD_HOME") or str(Path.home() / ".poormad")
