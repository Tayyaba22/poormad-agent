#!/usr/bin/env python3
"""Build the PoorMad Skills Index — a centralized JSON catalog of all skills.
...
`poormad skills search/install` can use it without hitting the GitHub API.
...
# Ensure POORMAD_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building PoorMad Skills Index...", flush=True)
