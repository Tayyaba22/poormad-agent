...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^PoorMad\s+(Agent|Audit)$", re.IGNORECASE),
    ...
    re.compile(r".*\[bot\]$", re.IGNORECASE),             # any GitHub [bot] suffix (poormad-seaeye[bot] etc.)
...
IGNORED_EMAILS = {
    ...
    "poormad@poormad.com",
    "poormad-audit@example.com",
    "nousbot@poormad.com",
    "poormad@habibilabs.dev",
    "omx@oh-my-codex.dev",
    "codex@openai.com",
