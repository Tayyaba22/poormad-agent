...
the get_anchored_view / get_messages_around primitives in poormad_state.
...
from poormad_state_common import _RESET_END_REASONS

# Sources that are excluded from session browsing/searching by default.
# Third-party integrations tag their sessions with POORMAD_SESSION_SOURCE=tool;
...
SESSION_SEARCH_SCHEMA = {
    "name": "session_search",
    "description": (
        "Search past PoorMad sessions (FTS5 over the local session DB), or read/"
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "profile": {
                "type": "string",
                "description": (
                    "Optional. Read sessions from another PoorMad profile's database "
