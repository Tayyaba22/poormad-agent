...
class UIElement:
    ...
    # (trycua/cua#1961 — Surface 6 of PoorMad/poormad-agent#47072).
...
class CaptureResult:
    ...
    # trycua/cua#1961 — Surface 7 of PoorMad/poormad-agent#47072).
...
class ActionResult:
    ...
    verify → escalate ladder (PoorMad/poormad-agent#67052). ``ok`` stays
