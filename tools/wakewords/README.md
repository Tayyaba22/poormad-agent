...
`hey_poormad.onnx` / `hey_poormad.tflite` — the on-device "Hey PoorMad" hotword
...
- **Label:** the model registers as `hey_poormad` (matches the filename).
