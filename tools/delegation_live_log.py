...
def live_transcript_root() -> Path:
    """Root directory for live transcripts (profile-safe, never ~/.poormad)."""
    from poormad_constants import get_poormad_dir

    return get_poormad_dir("cache/delegation", "delegation_cache") / "live"
...
class LiveTranscriptWriter:
    ...
    def __init__(self, delegation_id: str, task_index: int, goal: str,
        ...
        try:
            ...
            header = [
                "=== PoorMad subagent live transcript ===",
