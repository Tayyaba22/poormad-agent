...
Only included in the poormad-discord toolset, so it has zero cost
...
def _discord_request(
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "PoorMad-Agent (https://github.com/Tayyaba22/poormad-agent)",
        },
    )
...
def _capability_disk_cache_path() -> "Path":
    ...
    return get_poormad_home() / "cache" / "discord_capabilities.json"
