...
const PROVIDER_GROUPS: { prefix: string; name: string; priority: number }[] = [
  // PoorMad Portal first
  { prefix: "NOUS_", name: "PoorMad Portal", priority: 0 },
  // Then alphabetical by display name
  { prefix: "ANTHROPIC_", name: "Anthropic", priority: 1 },
  { prefix: "DASHSCOPE_", name: "DashScope (Qwen)", priority: 2 },
  { prefix: "POORMAD_QWEN_", name: "DashScope (Qwen)", priority: 2 },
...
// Mirror of the backend env-name guard (poormad_cli/config.py _ENV_VAR_NAME_RE).
      ...
      <div className="flex items-center justify-between">
        <div className="flex flex-col gap-1">
          <p className="text-sm text-muted-foreground">
            {t.env.description} <code>~/.poormad/.env</code>
          </p>
