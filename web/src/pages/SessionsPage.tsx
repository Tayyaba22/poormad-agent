...
const SOURCE_CONFIG: Record<string, { icon: typeof Terminal; color: string }> =
  {
    ...
    poormad_flow: { icon: Play, color: "text-warning" },
...
const NO_MATCHING_SESSION_SOURCE = "__poormad_dashboard_no_matching_source__";
        ...
        const res = await fetch(api.exportSessionUrl(id), {
          ...
          headers: {
            "X-PoorMad-Session-Token":
              (window as unknown as { __POORMAD_SESSION_TOKEN__?: string })
                .__POORMAD_SESSION_TOKEN__ ?? "",
          },
        });
