...
const STORAGE_KEY = "poormad-dashboard-theme";
...
const FONT_STORAGE_KEY = "poormad-dashboard-font";
...
const THEME_NAME_ALIASES: Record<string, string> = {
  // Renamed during the LENS_5I port + PoorMad-blue rebrand.
  "lens-5i": "nous-blue",
};
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `poormad_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "poormad-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-poormad-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-poormad-theme-font", "true");
...
function applyTheme(theme: DashboardTheme) {
  ...
  // (e.g. PoorMad Blue) doesn't leave its values behind when the user
