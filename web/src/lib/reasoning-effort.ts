 ...
 *
 * Values mirror poormad_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the PoorMad default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (PoorMad' default when unset). */
