...
export interface Translations {
  ...
  status: {
    ...
    updatePoorMadConfirmMessage?: string;
    updatePoorMadConfirmNow?: string;
    updatePoorMadConfirmTitle?: string;
    updatingPoorMad: string;
  ...
  // ── Achievements plugin (plugins/poormad-achievements) ──
  achievements: {
    hero: {
      kicker: string;
      title: string;
