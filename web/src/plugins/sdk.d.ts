/**
 * PoorMad Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__POORMAD_PLUGIN_SDK__`` and
 * ``window.__POORMAD_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__POORMAD_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``PoorMadPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@poormad/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__POORMAD_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__POORMAD_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__POORMAD_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface PoorMadPluginSDK {
  ...
  /**
   * Shared UI primitives (PoorMad DS / shadcn). Typed permissively at the
...
declare global {
  interface Window {
    __POORMAD_PLUGIN_SDK__?: PoorMadPluginSDK;
    __POORMAD_PLUGINS__?: PluginRegistry;
  }
}
