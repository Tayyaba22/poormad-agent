 ...
 * `window.__POORMAD_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the PoorMad brand in the top bar
 ...
 *  `window.__POORMAD_PLUGINS__.registerSlot(...)`.
 *
