...
def _default_registry_path() -> Path:
    return get_poormad_home() / "state" / _REGISTRY_NAME
...
class HostSupervisor:
    ...
    def __init__(
        ...
        *,
        ...
        expected_poormad_home: str | None = None,
        autostart: bool = True,
    ) -> None:
        ...
        self.expected_poormad_home = expected_poormad_home if expected_poormad_home is not None else str(get_poormad_home())
    ...
    def _spawn_locked(self, *, reason: str) -> None:
        ...
        if self.env:
            env.update(self.env)
        env["POORMAD_COMPUTE_HOST_HEARTBEAT_SECS"] = str(self.heartbeat_secs)
    ...
    def _validate_hello(self) -> None:
        ...
        got_home = str(hello.get("poormad_home") or "")
        if got_home and got_home != self.expected_poormad_home:
            raise RuntimeError(f"compute host POORMAD_HOME mismatch: {got_home} != {self.expected_poormad_home}")
