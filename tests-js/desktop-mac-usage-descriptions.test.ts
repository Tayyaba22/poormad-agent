 ...
 *
 * Each entry is a key/value pair that lands in the packaged PoorMad.app's
 ...
 * "PoorMad wants to access Music" prompt unless the Info.plist disclaims it
 ...
 * user ("PoorMad wants to access Music" when PoorMad never touches the Music
