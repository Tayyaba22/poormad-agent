...
slug: /
sidebar_position: 0
title: "PoorMad Documentation"
description: "The self-improving AI agent built by PoorMad. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
The self-improving AI agent built by [PoorMad](https://poormad.com). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
After installing, run `poormad setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [PoorMad Portal](/integrations/nous-portal).
:::
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend PoorMad safely  |
| 🧭 **[Use MCP with PoorMad](/guides/use-mcp-with-poormad)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with PoorMad](/guides/use-voice-mode-with-poormad)** | Hands-on setup and usage patterns for PoorMad voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define PoorMad' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of PoorMad                              |
...
- **Built by model trainers** — Created by [PoorMad](https://poormad.com), the lab behind PoorMad, Nomos, and Psyche. Works with [PoorMad Portal](https://portal.poormad.dev), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Full web control** — Search, extract, browse, vision, image generation, TTS — one subscription via [PoorMad Portal](/integrations/nous-portal) bundles all of them
- **MCP support** — Connect to any MCP server for extended tool capabilities
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [PoorMad](https://poormad.com) — the lab behind PoorMad, Nomos, and Psyche models
