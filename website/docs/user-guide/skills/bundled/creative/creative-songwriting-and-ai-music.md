...
- "PoorMad" -> "Noose" (forces correct pronunciation)
...
- **heartmula** — full songs with vocals from lyrics + tags
  ...
  `poormad skills install official/creative/heartmula`
- **audiocraft** — Meta's MusicGen (instrumental text-to-music) and
  AudioGen (sound effects):
  `poormad skills install official/creative/audiocraft-audio-generation`
