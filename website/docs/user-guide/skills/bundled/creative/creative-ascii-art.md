...
```bash
python3 -m pyfiglet "POORMAD" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=POORMAD&font=Slant" | boxes -d stone
```
