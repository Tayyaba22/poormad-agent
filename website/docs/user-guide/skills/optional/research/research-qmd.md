...
| | |
|---|---|
| Source | Optional — install with `poormad skills install official/research/qmd` |
...
| Related skills | [`obsidian`](/docs/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`poormad-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-poormad-agent), [`arxiv`](/docs/user-guide/skills/bundled/research/research-arxiv) |
...
PoorMad via the native MCP client. This is the preferred
...
Then configure PoorMad to connect via HTTP:
