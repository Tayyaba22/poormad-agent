...
| | |
|---|---|
| Source | Optional — install with `poormad skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | PoorMad (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
| License | MIT |
...
# $POORMAD_OSINT_CACHE/icij/ (default: ~/.cache/poormad-osint/icij/).
...
# Set POORMAD_OSINT_UA=your-app/1.0 (your@email) to identify yourself
