...
| | |
|---|---|
| Source | Optional — install with `poormad skills install official/research/gitnexus-explorer` |
...
| Related skills | [`poormad-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-poormad-agent), [`codebase-inspection`](/docs/user-guide/skills/bundled/github/github-codebase-inspection) |
...
- **The web UI does NOT create `.claude/` or `CLAUDE.md`.** Those are created by
  ...
  poormad-agent users don't need.
