...
| | |
|---|---|
| Source | Optional — install with `poormad skills install official/data-science/jupyter-notebook` |
...
| `execute_code` | One-shot scripts needing poormad tool access (web_search, file ops). Stateless. |
