...
| | |
|---|---|
| Source | Optional — install with `poormad skills install official/web-development/page-agent` |
...
- User wants **PoorMad itself to drive a browser** → use PoorMad' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
