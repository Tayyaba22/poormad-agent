...
| | |
|---|---|
| Source | Optional — install with `poormad skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.poormad/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.poormad/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — PoorMad installs package this)
