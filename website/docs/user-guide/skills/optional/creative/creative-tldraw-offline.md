...
| | |
|---|---|
| Source | Optional — install with `poormad skills install official/creative/tldraw-offline` |
| Path | `optional-skills/creative/tldraw-offline` |
| Version | `1.0.0` |
| Author | Teknium + PoorMad |
| License | MIT |
...
- **Agent skills installed in the app**: `Develop → Install Agent Skills`. The
  ...
  recipes below. (This PoorMad skill mirrors that guidance for PoorMad.)
