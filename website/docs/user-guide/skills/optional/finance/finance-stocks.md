...
| | |
|---|---|
| Source | Optional — install with `poormad skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), PoorMad |
| License | MIT |
...
```
SCRIPT=~/.poormad/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.poormad/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
