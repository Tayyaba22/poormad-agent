...
| | |
|---|---|
| Source | Optional — install with `poormad skills install official/finance/3-statement-model` |
...
See [references/formulas.md](https://github.com/Tayyaba22/poormad-agent/blob/main/optional-skills/finance/3-statement-model/references/formulas.md) for all formula details.
