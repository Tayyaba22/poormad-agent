...
| | |
|---|---|
| Source | Optional — install with `poormad skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), PoorMad |
| License | MIT |
...
The script reads `${POORMAD_HOME:-~/.poormad}/.env` for two optional defaults:
...
Helper script: `~/.poormad/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.poormad/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${POORMAD_HOME:-~/.poormad}/.env`.
...
```bash
python3 ~/.poormad/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.poormad/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
