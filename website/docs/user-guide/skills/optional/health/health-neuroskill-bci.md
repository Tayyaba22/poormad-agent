...
| | |
|---|---|
| Source | Optional — install with `poormad skills install official/health/neuroskill-bci` |
...
Connect PoorMad to a running [NeuroSkill](https://neuroskill.com/) instance to read
