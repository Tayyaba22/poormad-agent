...
| Model providers & transports | `agent/transports/`, `plugins/model-providers/`, `poormad_cli/models.py` | [Adding Providers](adding-providers.md), [Model Provider Plugins](model-provider-plugin.md), [Provider Runtime](provider-runtime.md) |
...
| CLI | `poormad_cli/` | [Extending the CLI](extending-the-cli.md) |
| Plugins system | `plugins/` | [Build a PoorMad Plugin](plugins/index.md) |
...
| Session storage | `poormad_state.py` | [Session Storage](session-storage.md) |
