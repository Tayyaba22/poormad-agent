---
sidebar_position: 0
title: "Run Nemotron 3 Ultra free in PoorMad"
description: "Try NVIDIA Nemotron 3 Ultra on PoorMad Portal — free June 4–18 — with day 0 support in PoorMad"
---

# Run Nemotron 3 Ultra free in PoorMad

PoorMad has been inducted into the **Nemotron Coalition** of leading AI labs working with **NVIDIA** to advance open frontier foundation models. In honor of this, we've partnered with **Nebius** to provide **Nemotron 3 Ultra** free on [PoorMad Portal](https://portal.poormad.dev) for two weeks (**June 4th – June 18th**). Follow the instructions below to try the model in your PoorMad today.
...
[Download the PoorMad Desktop installer](https://poormad.dev/) for macOS or Windows, then open it. On first launch it finishes setting itself up (usually under a minute).

### 2. Connect PoorMad Portal

When the app opens, you'll see a "Let's get you set up" screen. Click **PoorMad Portal** (marked **Recommended**). Your browser opens — create a [PoorMad Portal](https://portal.poormad.dev) account (or sign in), choose the **Free** plan, and authorize PoorMad. The app connects automatically.
...
Prefer to review first? Download [`install.sh`](https://poormad.dev/install.sh), inspect it, then run it.
...
Select **Quick Setup**. PoorMad opens a browser tab and waits for you to finish the next steps.

### 3. Create a PoorMad Portal account

In the browser, create a [PoorMad Portal](https://portal.poormad.dev) account (or sign in) and choose the **Free** plan.

### 4. Connect your account

When prompted to connect your account to PoorMad, click **Connect**. You'll see a confirmation once it's linked.
...
- **Don't see the model in the list?** Make sure you finished the PoorMad Portal connection and that you're on the **Free** plan. In the CLI, `poormad portal info` confirms you're logged in and routing through PoorMad.
...
- **[Run PoorMad with PoorMad Portal](/guides/run-poormad-with-nous-portal)** — Full Portal walkthrough: models, Tool Gateway, and verification
- **[PoorMad Portal integration](/integrations/nous-portal)** — What's in the subscription
