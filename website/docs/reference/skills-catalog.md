...
| [`poormad-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-poormad-agent) | Use, configure, theme, extend, and orchestrate PoorMad. | `autonomous-ai-agents/poormad-agent` |
...
| [`poormad-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-poormad-agent-skill-authoring) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development/poormad-agent-skill-authoring` |
| [`inspecting-poormad-desktop-dom`](/docs/user-guide/skills/bundled/software-development/software-development-inspecting-poormad-desktop-dom) | Read the live PoorMad desktop DOM/CSS over CDP. | `software-development/inspecting-poormad-desktop-dom` |
...
| [`plan`](/docs/user-guide/skills/bundled/software-development/software-development-plan) | Write a markdown plan to .poormad/plans/; no execution. | `software-development/plan` |
