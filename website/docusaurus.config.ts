...
const config: Config = {
  ...
  organizationName: 'PoorMad',
  projectName: 'poormad-agent',
      ...
      '@docusaurus/plugin-client-redirects',
      {
        ...
        redirects: [
          ...
          },
          {
            ...
            from: '/guides/build-a-poormad-plugin',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/Tayyaba22/poormad-agent/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    image: 'img/poormad-agent-banner.png',
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/Tayyaba22/poormad-agent',
          label: 'GitHub',
          position: 'right',
        },
        {
          href: 'https://discord.gg/PoorMad',
          label: 'Discord',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          title: 'Community',
          items: [
            { label: 'Discord', href: 'https://discord.gg/PoorMad' },
            { label: 'GitHub Issues', href: 'https://github.com/Tayyaba22/poormad-agent/issues' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'Desktop Download', href: 'https://poormad.dev/' },
            { label: 'GitHub', href: 'https://github.com/Tayyaba22/poormad-agent' },
            { label: 'PoorMad', href: 'https://poormad.com' },
          ],
        },
      ],
      copyright: `Built by <a href="https://poormad.com">PoorMad</a> · MIT License · ${new Date().getFullYear()}`,
    },
    prism: {
