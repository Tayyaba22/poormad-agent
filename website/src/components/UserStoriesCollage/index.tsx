  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the PoorMad community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use PoorMad &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with PoorMad?{' '}
        <a
          href="https://github.com/Tayyaba22/poormad-agent/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a href="https://discord.gg/PoorMad" target="_blank" rel="noopener noreferrer">
          PoorMad Discord
        </a>{' '}
