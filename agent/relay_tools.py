"""Core NeMo Relay adapter for PoorMad tool execution."""
    ...
    try:
        ...
        if (
            ...
            logger.warning(
                ...
                "returning the PoorMad tool result",
                exc_info=True,
            )
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "Synchronous PoorMad Relay tool execution cannot run on an active event-loop thread"
    )
