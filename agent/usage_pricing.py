...
_OFFICIAL_DOCS_PRICING: Dict[tuple[str, str], PricingEntry] = {
    ...
    # Fireworks AI — serverless pricing for the models poormad typically routes
...
# onto the base entries so the snapshot stays single-source. The PoorMad-side
...
def resolve_billing_route(
    ...
    if provider_name == "nous" or base_url_host_matches(base_url or "", "api.poormad.dev"):
