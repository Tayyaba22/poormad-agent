...
# ``data:`` field before PoorMad receives a completion chunk.  Keeping this
...
# See: https://github.com/Tayyaba22/poormad-agent/issues/69078
...
#
# See: https://github.com/Tayyaba22/poormad-agent/issues/27344
...
# case: a stream dies mid-response and PoorMad persists a content-less
...
# Request parameters that PoorMad sends on SOME routes only, paired with the
...
def classify_api_error(
    ...
    *,
    ...
    # poormad_cli.plugins.VALID_HOOKS for the callback contract). Callback
    ...
    try:
        from poormad_cli.plugins import get_plugin_error_classification
...
def _classify_by_status(
    ...
    *,
    ...
    if status_code == 401:
        ...
        # provider-specific refresh (Codex, Anthropic, PoorMad) run before
    ...
    if status_code == 404:
        # PoorMad API currently surfaces HA/NAS credit depletion as a paid model
