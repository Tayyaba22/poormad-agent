/**
 * Canonical PoorMad skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$POORMAD_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`poormad_cli/skin_engine.py`),
 ...
 *   • CLI     → `poormad_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
