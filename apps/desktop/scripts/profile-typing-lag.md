...
cd apps/desktop
XCURSOR_SIZE=24 POORMAD_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/poormad-typing
# → /tmp/poormad-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/poormad-typing.before.heapsnapshot
# → /tmp/poormad-typing.after.heapsnapshot
```
