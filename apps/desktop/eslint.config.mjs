...
export default [
  ...
  {
    // THE PLUGIN FENCE: plugins speak @poormad/plugin-sdk (+ react), never `@/…`
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              group: ['@/*', '../*', '@poormad/shared'],
              message: 'Plugins import only @poormad/plugin-sdk (and react). Missing something? Add it to the SDK.'
            }
          ]
        }
      ]
