...
// (#73044). Exercises the REAL poormad + store/gateway + store/profile chain:
...
const { pluginSocket, setApiRequestConnection, setApiRequestProfile } = await import('@/poormad')
...
const conn = (over: Partial<PoorMadConnection> = {}): PoorMadConnection =>
  ({
    authMode: 'oauth',
