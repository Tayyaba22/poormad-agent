...
export interface Translations {
  ...
  settings: {
    ...
    gateway: {
      ...
      sshKeyTitle: string
      sshKeyDesc: string
      sshPoorMadPathTitle: string
      sshPoorMadPathDesc: string
      sshPoorMadPathPlaceholder: string
  ...
  commandCenter: {
    ...
    poormadActiveSessions: (version: string, count: number) => string
