...
export const en: Translations = {
  ...
  boot: {
    ready: 'PoorMad Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading PoorMad settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote PoorMad backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingPoorMadDesktop: 'Starting PoorMad Desktop…'
    },
    errors: {
      backgroundExited: 'PoorMad background process exited.',
      backgroundExitedDuringStartup: 'PoorMad background process exited during startup.',
    ...
    failure: {
      ...
      cloudDownTitle: 'PoorMad Cloud agent is down',
      cloudDownDescription:
        'The PoorMad-managed cloud agent this gateway connects to is returning a server error. It cannot be restarted from here — check its status, switch to the local gateway, or get support.',
      cloudDownHint:
        'The buttons below open the PoorMad Portal (instance status and controls) and our Discord for support.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your PoorMad backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updatePoorMad: 'Update PoorMad',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting PoorMad Desktop.',
    ...
    native: {
      ...
      inputBody: 'PoorMad is waiting for your response.',
      turnDoneTitle: 'PoorMad finished',
      turnDoneBody: '',
  ...
  billingBlock: {
    titlePoorMad: 'Out of PoorMad credits',
  ...
  sendDiagnostics: {
    title: 'Send diagnostics to PoorMad',
    privacyNotice:
      'This uploads a debug bundle to PoorMad-internal storage (not a public paste). It includes system info (OS, versions, provider, which API keys are configured — never the keys themselves) and full agent, gateway, and desktop logs (up to 512 KB each), which likely contain conversation content, tool outputs, and file paths. Secrets are redacted before upload. The bundle is viewable only by PoorMad staff and allowlisted Discord moderators, and auto-deletes after 14 days.',
    upload: 'Upload',
    uploading: 'Uploading…',
    cancel: 'Cancel',
    close: 'Close',
    ...
    failedHint:
      'You can also run `poormad debug share --nous` from a terminal, or `poormad debug share --local` to print the report without uploading.',
    handoffLead: 'Pick up the discussion in:',
    links: {
      github: 'GitHub Issues',
      portal: 'PoorMad Portal Support',
      discord: 'Discord'
    }
  },
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to PoorMad defaults?',
    ...
    plugins: {
      ...
      agent: {
        title: 'Agent plugins',
        blurb:
          'Plugins you installed into the PoorMad backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.',
        ...
        updateBackendToManage: 'Update the PoorMad backend to manage this plugin from Desktop.',
      ...
      installModal: {
        ...
        agentTargetLocal: profile => `Installs into the ${profile} backend (~/.poormad/plugins/)`,
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while PoorMad is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'PoorMad asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while PoorMad was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while PoorMad was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let PoorMad follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and PoorMad can react to yours.',
      tipsTitle: 'In-App Tips',
      tipsDesc:
        'A small bubble pointing at one part of the app, shown occasionally while idle and by PoorMad when it helps. Closing one retires it for good.',
      tipsReset: (count: number) => `Bring back ${count} closed ${count === 1 ? 'tip' : 'tips'}`,
      toursTitle: 'Guided Tours',
      toursDesc: 'Let PoorMad walk you through the app, dimming the screen and spotlighting each step.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what PoorMad is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen PoorMad, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      heading: 'PoorMad Desktop',
      version: value => `Version ${value}`,
      versionUnavailable: 'Version unavailable',
      bundleOutOfSync: 'App build out of date',
      bundleOutOfSyncDesc:
        'The PoorMad runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      ...
      automaticUpdatesDesc:
        'PoorMad checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading PoorMad configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening PoorMad.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every PoorMad gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by PoorMad Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'PoorMad Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The PoorMad runtime managed by this app.',
      kindRemoteDesc: 'A PoorMad gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your PoorMad Cloud account.',
      kindSshDesc: 'A PoorMad install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers PoorMad manages (Authorization, Cookie, Host…) are ignored.',
      ...
      cloudAddHint:
        'Tip: signing in under PoorMad Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a PoorMad backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      envOverrideTitle: 'Environment variables are controlling this desktop session.',
      envOverrideDesc:
        'Unset POORMAD_DESKTOP_REMOTE_URL and POORMAD_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private PoorMad backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote PoorMad backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'PoorMad Cloud',
      cloudDesc: 'Sign in once to PoorMad Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'PoorMad Cloud',
      cloudSignIn: 'Sign in to PoorMad Cloud',
      cloudSignedIn: 'Signed in to PoorMad Cloud',
      cloudNeedsSignIn: 'Sign in to PoorMad Cloud to discover the agents on your account.',
      ...
      cloudNoAgents: {
        ...
        linkText: 'PoorMad portal',
        after: ', then refresh.'
      },
      cloudRefresh: 'Refresh',
      cloudConnect: 'Connect',
      cloudConnecting: 'Connecting…',
      cloudDiscoverFailed: 'Could not load your PoorMad Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'PoorMad Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of PoorMad Cloud',
      cloudSignedOutMessage: 'Cleared the PoorMad Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /poormad.',
      ...
      restartingMessage: 'PoorMad Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · PoorMad ${version}` : ''}`,
      ...
      sshDesc:
        'PoorMad is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshPoorMadPathTitle: 'PoorMad path (optional)',
      sshPoorMadPathDesc: 'Full path to the remote poormad binary. Blank = auto-detect.',
      sshPoorMadPathPlaceholder: 'auto-detect',
      sshTestConnection: 'Test SSH',
      sshConnect: 'Connect',
      sshButtonsHint: 'Save applies on the next launch. Connect reconnects now.',
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — PoorMad found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — PoorMad runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'PoorMad is not installed on the remote host. Install it there (curl -fsSL https://poormad.dev/install.sh | sh) or set the PoorMad path.',
      sshErrPlatform:
        'Unsupported remote platform. PoorMad Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update PoorMad on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to PoorMad. Review the exact configuration below — it comes from the link, not from PoorMad.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. PoorMad runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point PoorMad at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
    ...
    toolsets: {
      ...
      nousIncluded: 'Included with a PoorMad subscription — sign in to PoorMad Portal to activate.',
      nousAuthNeededTitle: 'Sign in to PoorMad Portal',
      nousAuthNeededMessage: provider => `${provider} is saved but won't activate until you sign in to PoorMad Portal.`,
      nousAuthSignIn: 'Sign in',
      nousAuthDoneTitle: 'PoorMad Portal connected',
      nousAuthDoneMessage: 'Your subscription backends are now active.',
      nousAuthFailed: 'PoorMad Portal sign-in did not complete',
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via poormad curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As PoorMad builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart PoorMad to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update PoorMad to generate pets.',
      backgroundHint: 'You can close this — PoorMad will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure PoorMad desktop' },
    ...
    poormadActiveSessions: (version, count) => `PoorMad ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@poormad:example.org' },
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description: 'Sessions in this profile will run on the remote PoorMad you point it at, instead of this computer.',
      urlLabel: 'Remote address',
      urlPlaceholder: 'https://poormad.example.com',
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent PoorMad environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'PoorMad did not save that model change.',
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. PoorMad will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the PoorMad backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from PoorMad. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the PoorMad backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting PoorMad...',
    placeholderReconnecting: 'Reconnecting to PoorMad…',
    ...
    attachUrlDesc: 'PoorMad will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask PoorMad to open PR',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating PoorMad…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting PoorMad…',
    ...
    unsupportedMessage: 'This version of PoorMad can’t update itself from inside the app.',
    ...
    manualBody: 'You installed PoorMad from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'PoorMad will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the PoorMad desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The PoorMad updater takes over in its own window and reopens PoorMad automatically when it’s done. Please don’t reopen PoorMad yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. PoorMad reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then PoorMad reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update PoorMad?',
    blockerBody:
      'PoorMad needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update PoorMad',
    foreignBlockerBody:
      'PoorMad can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'PoorMad can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  install: {
    ...
    oneTimeTitle: 'PoorMad needs a one-time install',
    ...
    setupChoiceTitle: 'Set up PoorMad Desktop',
    setupChoiceDesc:
      'Connect this app to a PoorMad gateway you already run, or install PoorMad locally on this computer.',
    connectExistingTitle: 'Connect to existing PoorMad',
    ...
    installLocalTitle: 'Install PoorMad locally',
    installLocalDesc: 'Download PoorMad, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart PoorMad Desktop and try again.',
    remoteSetupTitle: 'Connect to existing PoorMad',
    remoteSetupDesc: 'Enter your gateway URL. PoorMad Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the PoorMad gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/poormad',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that PoorMad gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up PoorMad',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another PoorMad CLI or desktop instance is running. Stop any running PoorMad instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with PoorMad",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'PoorMad is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting PoorMad…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run PoorMad',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point PoorMad at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — PoorMad connects automatically',
    ...
    authorizeThere: 'Authorize PoorMad there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize PoorMad there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  modelPicker: {
    ...
    pro: 'Pro',
    proNeedsSubscription: 'Pro models need a paid PoorMad subscription.',
    free: 'Free',
    freeTier: 'Free tier',
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `PoorMad Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `PoorMad Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. PoorMad will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'PoorMad is restarting...',
      askRestart: 'Ask PoorMad to restart the server',
      lookingRestart: taskId => `PoorMad is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'PoorMad is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask PoorMad to open a page.',
      finishedRestarting: message => `PoorMad finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'PoorMad could not restart the server.',
      stillWorking:
        'PoorMad is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'PoorMad is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'PoorMad gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.poormad/config.yaml). PoorMad won’t ask again for commands like this — in this session or any future one.`,
    ...
    mcpSetup: {
      ...
      catalogSource: 'From the PoorMad-approved catalog',
  ...
  prompts: {
    ...
    sudoDesc: 'PoorMad needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'PoorMad needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart PoorMad Desktop to use Save Image.',
    restartToSaveImages: 'Restart PoorMad Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `poormad gateway` running?'
    }
  },
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        title: 'Teach it once',
        text: 'Skills are folders of instructions PoorMad loads when the work calls for them.'
      },
      messaging: {
        title: 'PoorMad away from your desk',
        text: 'Connect Telegram, Discord, Slack and more — same agent, same memory.'
      },
      artifacts: {
        title: 'Everything PoorMad made',
      ...
      profiles: {
        ...
        text: 'Each one is its own PoorMad — own keys, own memory, own sessions.'
      },
      'composer-mentions': {
