 ...
 * `<poormad home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'poormad.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'poormad.desktop.disabledPlugins.v1'
