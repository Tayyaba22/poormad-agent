...
describe('displayPath', () => {
  it('collapses a macOS home prefix to ~', () => {
    expect(displayPath('/Users/brooklyn/www/poormad-agent')).toBe('~/www/poormad-agent')
...
describe('pathLeaf', () => {
  it('returns the last segment', () => {
    expect(pathLeaf('/Users/me/www/poormad-agent')).toBe('poormad-agent')
    expect(pathLeaf('~/www/poormad-agent')).toBe('poormad-agent')
