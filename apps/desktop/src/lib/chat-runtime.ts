...
import type { ModelOptionsResponse, SessionInfo } from '@/types/poormad'
 ...
 *
 * Only the leading status prefix (e.g. "PoorMad is thinking...") and the
 ...
 *  resolved comment as JSON (PoorMadPrComment shape); a malformed payload falls
