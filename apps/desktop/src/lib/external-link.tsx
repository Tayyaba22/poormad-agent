...
const SKIP_PROTO_RE = /^(?:file|data|mailto|javascript|blob|chrome|about|poormad):/i
...
export function fetchLinkTitle(url: string): Promise<string> {
  ...
  const bridge = typeof window === 'undefined' ? undefined : window.poormadDesktop?.fetchLinkTitle
...
export function openExternalLink(href: string): void {
  if (href) {
    void window.poormadDesktop?.openExternal?.(href)
  }
}
 ...
 * doesn't cost a context switch out of PoorMad, and it is the surface the agent
