...
describe('installSelectionCopyColorGuard', () => {
  beforeEach(() => {
    document.documentElement.dataset.poormadMode = 'dark'
  })

  afterEach(() => {
    delete document.documentElement.dataset.poormadMode
    window.getSelection()?.removeAllRanges()
  })
  ...
  it('leaves light-ink selections alone when the theme is light', () => {
    document.documentElement.dataset.poormadMode = 'light'
