...
//               discussion: GitHub Issues · PoorMad Portal Support · Discord.
...
const SUPPORT_LINKS = [
  { key: 'github', url: 'https://github.com/Tayyaba22/poormad-agent/issues' },
  { key: 'portal', url: 'https://portal.poormad.dev/help' },
  { key: 'discord', url: 'https://discord.gg/PoorMad' }
] as const
