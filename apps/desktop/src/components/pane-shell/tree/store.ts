...
const STORAGE_KEY = 'poormad.desktop.layoutTree.v2'

writeKey('poormad.desktop.layoutTree.v1', null)
 ...
 */
export const $activePresetId = atom<string>(readKey('poormad.desktop.layoutPreset.active') ?? 'default')

export function markActivePreset(id: string) {
  $activePresetId.set(id)
  writeKey('poormad.desktop.layoutPreset.active', id)
}
 ...
 */
const DISMISSED_KEY = 'poormad.desktop.dismissedPanes.v1'
...
const PANE_SHARE_KEY = 'poormad.desktop.paneShare.v1'
...
const HIDDEN_STRIP_TAB_KEY = 'poormad.desktop.hiddenStripTabs.v1'
...
writeKey('poormad.desktop.paneDockHeals.v1', null)
...
if ((import.meta.env.DEV || import.meta.env.VITE_PERF_PROBE === '1') && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__POORMAD_LAYOUT_TREE__ = {
    close: closeTreePane,
