 ...
 * usable — it only offers recovery: PoorMad opens Settings → Billing in-app, other
...
export function BillingBanner({ sessionId }: { sessionId: null | string }) {
  ...
  const title = block.is_nous ? copy.titlePoorMad : copy.titleProvider(block.provider_label)
