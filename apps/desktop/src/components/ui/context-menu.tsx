...
export const POORMAD_CONTEXT_MENU_TRIGGER_ATTR = 'data-poormad-context-menu-trigger'

function ContextMenuTrigger({ ...props }: React.ComponentProps<typeof ContextMenuPrimitive.Trigger>) {
  return (
    <ContextMenuPrimitive.Trigger data-slot="context-menu-trigger" {...props} data-poormad-context-menu-trigger="" />
  )
}
