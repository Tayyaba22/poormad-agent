/**
 * PoorMad skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$POORMAD_HOME/skins/` (or a
 * built-in) resolved by `poormad_cli/skin_engine.py` and pushed to every surface
 ...
 * skin PoorMad authors from a prompt lights up all three surfaces from one file.
 *
...
import type { PoorMadSkin, SkinColors } from '@poormad/shared/skin'
 ...
 */
export function skinToDesktopTheme(skin: PoorMadSkin): DesktopTheme | null {
