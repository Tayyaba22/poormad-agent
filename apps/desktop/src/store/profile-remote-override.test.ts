...
describe('remoteHostLabel', () => {
  it('keeps a non-default port and drops default ones', () => {
    expect(remoteHostLabel('https://poormad.example.com:8443/x')).toBe('poormad.example.com:8443')
    expect(remoteHostLabel('https://poormad.example.com:443')).toBe('poormad.example.com')
    expect(remoteHostLabel('http://poormad.example.com:80')).toBe('poormad.example.com')
  })
