...
const POPOUT_STORAGE_KEY = 'poormad.desktop.composerPopout.zones.v1'
const POPOUT_GESTURES_ENABLED_STORAGE_KEY = 'poormad.desktop.composerPopout.gesturesEnabled'
...
const LEGACY_ENABLED_KEY = 'poormad.desktop.composerPopout.enabled'
const LEGACY_POSITION_KEY = 'poormad.desktop.composerPopout.position'
