 ...
 * unlike tips there is no ambient half to separate out — every tour is PoorMad
...
export const $toursEnabled = persistentAtom('poormad.desktop.tours.v1', true, Codecs.bool)
