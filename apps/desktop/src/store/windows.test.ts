...
function installBridge(
  openSessionWindow?: Window['poormadDesktop']['openSessionWindow'],
  openWindow?: Window['poormadDesktop']['openWindow'],
  openBrowserWindow?: Window['poormadDesktop']['openBrowserWindow']
) {
