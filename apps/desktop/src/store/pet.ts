...
export interface PetInfo {
  ...
  // the PoorMad "run" activity state uses the in-place running row).
 ...
 * POORMAD_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'poormad.desktop.pet-roam.v1'
