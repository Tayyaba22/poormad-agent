...
function identityForConnection(connection: PoorMadConnection | null): string {
  if (!connection) {
    return ''
  }
...
export function syncCronModelImpactConnection(connection: PoorMadConnection | null): void {
