...
function rehydrateFromDiskOnce(): void {
  ...
  try {
    const rawSeen = readKey('poormad.desktop.sessionSeenCounts')
    ...
    const rawMarkers = readKey('poormad.desktop.unreadFinishedSessions')
