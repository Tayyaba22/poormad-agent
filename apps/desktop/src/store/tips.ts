 ...
 * - It covers PoorMad too. "Off" from someone who has just closed a bubble means
...
export const $tipsEnabled = persistentAtom('poormad.desktop.tips.rotation.v1', true, Codecs.bool)
export const $retiredTips = persistentAtom<string[]>('poormad.desktop.tips.retired.v1', [], Codecs.stringArray)
export const $lastTipId = persistentAtom<null | string>('poormad.desktop.tips.last.v1', null, Codecs.nullableText)
export const $nextTipAt = persistentAtom<null | number>(
  'poormad.desktop.tips.next.v1',
  null,
