...
test('generated protocol uses poormad profile list, not the invalid profiles plural', () => {
  assert.match(source, /run `poormad profile list` for the LIVE/)
  assert.doesNotMatch(source, /run `poormad profiles list` for the LIVE/)
})
