...
import { type DroppedFile, extractDroppedFiles, POORMAD_PATHS_MIME } from './use-composer-actions'
...
const dragKindOf = (event: ReactDragEvent): DragKind =>
  dragHasAttachments(event.dataTransfer, POORMAD_PATHS_MIME) ? 'files' : null
