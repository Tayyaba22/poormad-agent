...
const FOCUS_EVENT = 'poormad:composer-focus'
const INSERT_EVENT = 'poormad:composer-insert'
const ATTACH_IMAGES_EVENT = 'poormad:composer-attach-images'
const INSERT_REFS_EVENT = 'poormad:composer-insert-refs'
const SUBMIT_EVENT = 'poormad:composer-submit'
const VOICE_TOGGLE_EVENT = 'poormad:composer-voice-toggle'
const MODEL_MENU_EVENT = 'poormad:composer-model-menu'
