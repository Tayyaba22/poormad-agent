...
import type { PoorMadGitBranch } from '@/global'
...
const branchActionLabel = (branch: PoorMadGitBranch, copy: BranchActionCopy) => {
...
export function WorktreeDialog() {
  ...
  const [branches, setBranches] = useState<PoorMadGitBranch[]>([])
  ...
  const convert = async (branch: PoorMadGitBranch) => {
    if (pending || !repoPath || !branch) {
      return
    }
