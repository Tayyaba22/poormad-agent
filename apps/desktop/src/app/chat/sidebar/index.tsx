...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/poormad'
...
// highlight markers (sqlite snippet() delimiters — see poormad_state_search.py).
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('poormad:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('poormad:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask PoorMad to
