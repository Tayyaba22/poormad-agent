...
import type * as PoorMadApi from '@/poormad'
...
vi.mock('@/poormad', async importOriginal => ({
  ...(await importOriginal<typeof PoorMadApi>()),
...
describe('SkillsView toolset management', { timeout: 60_000 }, () => {
    ...
    await act(async () => {
      window.dispatchEvent(
        new MessageEvent('message', {
          data: { type: 'poormad-skill-pick', name: 'web-research', identifier: 'web-research' },
          origin: 'https://poormad.dev'
        })
      )
    })
  ...
  it('offers (connection, profile) scope rows on multi-connection desktops', async () => {
    ...
    ;(window as { poormadDesktop?: unknown }).poormadDesktop = { connections, getAgentRoster }
