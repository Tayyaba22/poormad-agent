...
export const FALLBACK_PORTAL_BILLING_URL = 'https://portal.poormad.dev/billing'
export const FALLBACK_PORTAL_URL = 'https://portal.poormad.dev'
  ...
  if (!billing.logged_in || subscription?.logged_in === false) {
    return {
      notice: {
        ...
        message: 'Run /portal in the TUI or open the PoorMad portal to connect your account.',
