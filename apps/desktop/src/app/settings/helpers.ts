...
import type { ConfigFieldSchema, PoorMadConfigRecord, ToolsetInfo } from '@/types/poormad'
...
export function getNested(obj: PoorMadConfigRecord, path: string): unknown {
  let cur: unknown = obj
 ...
 */
export function clearsEnabledToolsets(prev: PoorMadConfigRecord, next: PoorMadConfigRecord): boolean {
...
export function voiceFieldVisible(key: string, config: PoorMadConfigRecord): boolean {
...
export function setNested(obj: PoorMadConfigRecord, path: string, value: unknown): PoorMadConfigRecord {
...
function personalityOptions(config: PoorMadConfigRecord): string[] {
...
function commandProviderNames(config: PoorMadConfigRecord, section: 'tts' | 'stt'): string[] {
