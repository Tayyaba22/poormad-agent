...
vi.mock('@/poormad', () => ({
  savePoorMadConfig: (config: Record<string, unknown>) => mocks.save(config)
}))
...
vi.mock('../hooks/use-config-record', () => ({
  setPoorMadConfigCache: (config: Record<string, unknown>) => mocks.cache(config),
  usePoorMadConfigRecord: () => ({ data: mocks.loadedConfig })
}))
