...
import type { StarmapEdge, StarmapGraph, StarmapNode } from '@/types/poormad'
...
const VERSION = 3
const PREFIX = 'HML' // "PoorMad Memory Loadout" — namespaces our codes like WoW's leading bytes.
