import type { PoorMadReviewFile } from '@/global'
...
export function buildReviewFlatList(files: PoorMadReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: PoorMadReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
