...
const TAKEOVER_KEY = 'poormad.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which PoorMad can't clear via the API — the user
 *  sees exactly what runs instead of PoorMad silently deleting their creds. */
