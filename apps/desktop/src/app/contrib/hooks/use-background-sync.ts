...
import { getLatestSessionMessages, type ProfileScope } from '@/poormad'
...
interface BackgroundSyncParams {
  ...
  refreshPoorMadConfig: () => Promise<unknown> | unknown
...
export function useBackgroundSync({
  ...
  }, [activeSessionId, freshDraftReady, gatewayState, refreshCurrentModel, refreshPoorMadConfig])
}
