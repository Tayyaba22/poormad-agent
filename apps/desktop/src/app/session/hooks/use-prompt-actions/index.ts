...
import { transcribeAudio } from '@/poormad'
...
export function usePromptActions({
  ...
  // succeeds on POORMAD01 and prompt.submit immediately fails locally with
  // "session not found".
  ...
  // separate `poormad gateway` process performs the actual transfer, so we
