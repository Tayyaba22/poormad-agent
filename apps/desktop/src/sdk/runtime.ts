 ...
 * plugins resolve `@poormad/plugin-sdk` through the vite alias; RUNTIME-loaded
...
const GLOBALS = {
  __POORMAD_PLUGIN_SDK__: sdk,
  __POORMAD_REACT__: React,
  __POORMAD_REACT_JSX__: jsxRuntime,
  __POORMAD_REACT_JSX_DEV__: jsxDevRuntime
} as const
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@poormad/plugin-sdk': shimUrl('__POORMAD_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__POORMAD_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__POORMAD_REACT_JSX__'),
    react: shimUrl('__POORMAD_REACT__')
  }
