 ...
 * Apps) login to a gated PoorMad gateway: system-browser + loopback redirect +
 ...
 * upstream IDP (PoorMad Portal) issues a per-gateway-instance client_id and only
...
// poormad_cli/web_server.py status handler.
