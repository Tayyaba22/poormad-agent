...
// by main.ts (`setBackgroundThrottling` driven by the merged `poormad:active-work`
...
// (the "PoorMad idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey PoorMad" wake word has NO preceding click,
