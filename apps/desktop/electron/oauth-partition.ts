 ...
 * (`persist:poormad-remote-oauth`) — the jar was keyed on the auth *mode*, not
 ...
 * setup: one box, two dashboards) fought over the same `poormad_session*`
 ...
 *     cascade deliberately shares one jar with the PoorMad Portal session.
...
export const LEGACY_OAUTH_PARTITION = 'persist:poormad-remote-oauth'
