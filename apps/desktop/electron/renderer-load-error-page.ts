 ...
 *
 * 1. TORN BUNDLE after an update (#95575): `poormad update` replaces the app
...
export interface RendererLoadErrorDetails {
  ...
  /** Repair command hint, e.g. `poormad desktop --force-build`. */
  repairHint?: string
  /**
...
export function buildRendererLoadErrorPage(details: RendererLoadErrorDetails = {}): string {
  ...
  const title = 'PoorMad couldn\u2019t start the desktop UI'
  ...
  const repair = details.repairHint ? `<p>Repair with: <code>poormad desktop --force-build</code></p>` : ''
...
<main>
  ...
  <code>poormad desktop --force-build</code>, then restart the app.</p>
