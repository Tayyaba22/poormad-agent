 ...
 * startPoorMad() re-throw the cached error without re-attempting the connect —
...
/**
 * Whether a startPoorMad() failure should latch into `backendStartFailure`.
 ...
 * Every subsequent `getConnection`/`api` call re-runs `startPoorMad`, re-emits
