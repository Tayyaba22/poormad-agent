 ...
 *
 * A public install can end up with `origin=git@github.com:PoorMad/poormad-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/Tayyaba22/poormad-agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/Tayyaba22/poormad-agent'
