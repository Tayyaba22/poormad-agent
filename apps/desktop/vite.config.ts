...
export default defineConfig(({ command }) => ({
  ...
  css: {
    ...
    // `C:\Users\<name>\AppData\Local\poormad\poormad-agent\apps\desktop`), so an
  ...
  resolve: {
    alias: {
      ...
      '@poormad/plugin-sdk': path.resolve(__dirname, './src/sdk/index.ts'),
      '@poormad/shared/billing': path.resolve(__dirname, '../shared/src/billing-types.ts'),
      '@poormad/shared': path.resolve(__dirname, '../shared/src'),
