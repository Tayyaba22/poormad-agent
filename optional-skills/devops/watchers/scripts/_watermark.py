...
def _state_dir() -> Path:
    ...
    # Default: $POORMAD_HOME/watcher-state/, falling back to ~/.poormad/watcher-state/.
    poormad_home = os.environ.get("POORMAD_HOME") or str(Path.home() / ".poormad")
    return Path(poormad_home) / "watcher-state"
