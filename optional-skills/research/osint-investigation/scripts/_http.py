...
DEFAULT_UA = (
    "poormad-osint-investigation/0.2 "
    "(+https://github.com/Tayyaba22/poormad-agent; "
    "set POORMAD_OSINT_UA env var to identify yourself per "
...
def get(
    ...
    *,
    ...
    h = {"User-Agent": user_agent or os.environ.get("POORMAD_OSINT_UA", DEFAULT_UA)}
    if headers:
        h.update(headers)
