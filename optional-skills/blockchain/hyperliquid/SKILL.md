...
```bash
python ~/.poormad/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
```bash
python ~/.poormad/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python ~/.poormad/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
