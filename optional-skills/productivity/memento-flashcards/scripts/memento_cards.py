...
Data file: $POORMAD_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_POORMAD_HOME = Path(os.environ.get("POORMAD_HOME", Path.home() / ".poormad"))
DATA_DIR = _POORMAD_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
