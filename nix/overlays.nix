# nix/overlays.nix — Expose pkgs.poormad-agent for external NixOS configs
#
...
# `pkgs.poormad-agent`, `nix build .#default`, and the NixOS module's
...
{ inputs, ... }:
{
  flake.overlays.default = final: _: {
    poormad-agent = inputs.self.packages.${final.stdenv.hostPlatform.system}.default;
  };
}
