      ...
      let
        ...
        excludedDirs =
          ...
          jsWorkspaceTopDirs ++ [
            ...
            "nix"
            # Skills are shipped via POORMAD_BUNDLED_SKILLS /
            # POORMAD_OPTIONAL_SKILLS (see poormad-agent.nix), not via the
            ...
            # __init__.py) shipped via symlinks + POORMAD_BUNDLED_LOCALES
            # / POORMAD_OPTIONAL_MCPS, not via the wheel. Excluding them
