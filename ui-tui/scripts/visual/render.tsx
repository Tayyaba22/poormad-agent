 ...
 * across theme x background scenes to <tmpdir>/poormad-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@poormad/ink'
...
// The regenerated slate light_colors block from poormad_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/poormad-agent',
...
const setup = (bgHex: string) => {
  process.env.POORMAD_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}
