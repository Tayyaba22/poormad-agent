...
await build({
  ...
  // Skip the prebuilt @poormad/ink bundle and inline the source instead:
  ...
  alias: { '@poormad/ink': resolve(root, 'packages/poormad-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The poormad_cli launcher
