...
import type { ScrollBoxHandle } from '@poormad/ink'
import { evictInkCaches } from '@poormad/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.POORMAD_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
