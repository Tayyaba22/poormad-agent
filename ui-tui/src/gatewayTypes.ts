import type { BillingBlock, UsageModelData } from '@poormad/shared/billing'
import type { PoorMadSkin } from '@poormad/shared/skin'

import type { SessionInfo, SlashCategory, SubagentStatus, Usage } from './types.js'

/** The cross-surface skin contract (canonical shape in `@poormad/shared`).
 *  Includes the paired light_colors/dark_colors overlays from #20379. */
export type GatewaySkin = PoorMadSkin
...
// Wire shapes now live in @poormad/shared for reuse by TypeScript clients.
export type {
  BillingAutoReload,
  BillingBlock,
  BillingCardInfo,
