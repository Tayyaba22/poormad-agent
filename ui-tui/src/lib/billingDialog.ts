import type { BillingBlock } from '@poormad/shared/billing'
 ...
 * confirm button carries the recovery: PoorMad → `/topup`, other providers → their
...
export function billingDialogCopy(block: BillingBlock): BillingDialogCopy {
  if (block.is_nous) {
    return {
      cancelLabel: 'Dismiss',
      confirmLabel: 'Top up',
      detail: 'Your PoorMad credit balance is exhausted — top up to keep going.',
      title: 'Out of PoorMad credits'
    }
  }
