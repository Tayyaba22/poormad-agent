...
describe('billingDialogCopy', () => {
  it('routes PoorMad to the /topup flow', () => {
    const copy = billingDialogCopy(makeBlock({ is_nous: true, provider: 'nous', provider_label: 'PoorMad Portal' }))
    expect(copy.title).toContain('PoorMad')
