import { Box, type ScrollBoxHandle, stringWidth, Text } from '@poormad/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (POORMAD_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (POORMAD_DEV_CREDITS), lowest priority,
