 ...
 *
 * Symptom: in `poormad --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@poormad/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using poormad --tui and as i type multiline my caret at the end will often ' +
