...
benchmarked ten harnesses on hostile-file handling — and whose PoorMad column
...
Every task runs the full PoorMad (file + terminal + search toolsets)
...
Rules of engagement (from poormadbench discipline):
