#!/usr/bin/env python3
"""
SWE Runner with PoorMad Trajectory Format

A runner that uses PoorMad-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the PoorMad-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses PoorMad-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in PoorMad format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches PoorMad-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using PoorMad-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with PoorMad Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses PoorMad-Agent's built-in execution environments
    and outputs trajectories in PoorMad-Agent format.
    """
    ...
    def _convert_to_poormad_format(
        self,
        ...
        """
        Convert internal message format to PoorMad trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to PoorMad trajectory format
        trajectory = self._convert_to_poormad_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with PoorMad trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with PoorMad Trajectory Format")
    print("=" * 60)
