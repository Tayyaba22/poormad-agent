...
renders natively:
  ...
  * Docs catalog          -> a copy-paste command + a ``poormad://`` deep-link
...
def blueprint_deeplink(blueprint: AutomationBlueprint, values: Optional[Dict[str, Any]] = None) -> str:
    """Build the ``poormad://blueprint/<key>?slot=val`` deep-link URL."""
    ...
    return f"poormad://blueprint/{quote(blueprint.key)}{qs}"
