"""Durable aggregation and local export for PoorMad shared metrics."""
...
from poormad_cli.sqlite_util import write_txn
...
_PACKAGE_SCHEMA_VERSION = "poormad.shared_metrics.v2"
...
class SharedMetricsStore:
    ...
    def __init__(
        ...
        root = get_poormad_home() / "telemetry" / "shared_metrics"
        ...
        return [
            {
                ...
                "resource": {
                    "poormad_version": row["poormad_version"],
    ...
    def _ensure_schema(self) -> None:
        with self._connection(busy_timeout_ms=_SCHEMA_BUSY_TIMEOUT_MS) as connection:
            # Serialize first-run creation and upgrades across PoorMad processes.
            with write_txn(connection):
    ...
    def _create_package_in_transaction(
        ...
        resource = {
            "poormad_version": period_row["poormad_version"],
