"""Relay subscriber for the persisted PoorMad shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated PoorMad counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the PoorMad shared metric: %s",
                    metric_name,
                    exc_info=True,
                )
