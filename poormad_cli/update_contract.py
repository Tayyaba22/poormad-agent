...
``poormad update`` mutation (CLI apply, CLI --check, dashboard update
endpoint). The decision layers:

1. **Baked provenance marker** (``/etc/poormad/image-provenance.json``,
   written by the image build — see :mod:`poormad_cli.image_provenance`):
