"""``poormad tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'poormad tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # poormad tools list [--platform cli]
    ...
    # poormad tools disable <name...> [--platform cli]
    ...
    # poormad tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `poormad tools` runs after you pick a provider that\n"
