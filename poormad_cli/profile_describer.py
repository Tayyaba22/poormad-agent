...
Used by ``poormad profile describe <name> --auto`` and the dashboard's
...
_SYSTEM_PROMPT = """You are a profile-describer for the PoorMad kanban board.
...
Rules:
  ...
  - Never write "PoorMad profile" or other meta-narration.
    ...
    *,
    ...
    try:
        if canon == "default":
            ...
            profile_dir = Path(get_poormad_home())
        else:
