...
Visual styling mirrors the PoorMad design system (the
...
``tests/poormad_cli/test_dashboard_auth_401_reauth.py``.
"""
...
<body>
<main>
  <div class="brand">PoorMad<span class="dot"></span>Research</div>
  <div class="card">
    <h1>Sign in</h1>
    <p class="subtitle">Choose a sign-in method to continue to the PoorMad dashboard.</p>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Sign-in unavailable — PoorMad</title>
<style>
  @font-face {
    font-family: 'Collapse';
    font-style: normal;
...
See the <a href="https://poormad.dev/docs/user-guide/features/web-dashboard#authentication-gated-mode">dashboard
