"""
PoorMad CLI - Unified command-line interface for PoorMad.

Provides subcommands for:
- poormad chat          - Interactive chat (same as ./poormad)
- poormad gateway       - Run gateway in foreground
- poormad gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `poormad setup` on a fresh Pi.
    ...
    poormad_cli/stdio.py::configure_windows_stdio() runs later from the entry
