...
Entry point: ``poormad whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``poormad_cli/main.py``).
...
PoorMad gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures PoorMad to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  PoorMad needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the PoorMad gateway in another terminal:")
    print("         poormad gateway")
    print()
    ...
    print()
    print("  Docs: https://poormad.dev/docs/user-guide/")
