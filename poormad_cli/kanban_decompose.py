...
Invoked by ``poormad kanban decompose [task_id | --all]`` and the
...
* Mirrors the shape of ``poormad_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the PoorMad board.
...
def _profile_author() -> str:
    """Mirror of ``poormad_cli.kanban._profile_author``."""
    return (
